 ...
 * <ul>
 *    <li>no Ordering is specified,</li> //没有指定排序
 *    <li>no Aggregator is specified, and</li> // 没有指定聚合函数
 *    <li>the number of partitions is less than  //分区数量小于spark.shuffle.sort.bypassMergeThreshold
